 ...
 */
data class LandmarkDataObject(val id: String, val hint: Int, val name: Int, val location: LatLng)
...
internal object GeofencingConstants {
     ...
     */
    /* Тут настраиваем время жизни точки */
    val GEOFENCE_EXPIRATION_IN_MILLISECONDS: Long = TimeUnit.HOURS.toMillis(1)

    /* Все точки взяли из json файла */
